...
(function($) {
	...
	$(function() {
		...
		// Scrolly.
			...
			$(".infoBoxHeadline").attr('unselectable','on')
     .css({'-moz-user-select':'-moz-none',
           ...
           'user-select':'none'
			...
			$(".box.style1").on("click", function(event){
				var all = document.getElementsByClassName("infoBoxParagraph");
				for (var i=0, max=all.length; i < max; i++) {
				     // Do something with the element her
				     console.log(all[i]);
				     $(all[i]).hide("fast");				}
